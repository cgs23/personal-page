            ...
            <div class="side front">
                <div class="grid-item title">
                    ...
                    <div class="grid-item but">
                        <button class="btn btn-lg" :class="{'btn-outline-light': darkmode, ' btn-outline-dark': !darkmode}" @click='flipCard'>Details</button>
                 </div>
            </div>
            ...
            <div class="side back">
                    <div class="grid-item icons">
                        <span v-for='(icon, index) in icons' :key='icon.id'>
                            <v-icon :name='icon.name' scale="2.2" :title='icon.title' :class="{grey: darkmode, purp: !darkmode}"/>
                    ...
                    <div class="grid-item but">
                        <button class="btn" :class="{'btn-outline-light': darkmode, ' btn-outline-dark': !darkmode}" @click='flipCard'>
