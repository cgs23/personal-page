<template>
  <div class="container-fluid pad text-right">
    ...
    <h4>My name is Stavros Giannakis, I am {{ age }} old, currently living in Berlin, Germany. <br>
      ...
      I am a Software Engineer with 6+ years of work experience, with a variety of development frameworks. Furthermore,
      ...
      Currently, I am working as a full stack developer (NestJS / Angular) for PowerUs GmbH.
    </h4>
  </div>
</template>
